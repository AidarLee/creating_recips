...
class RegionChoice(models.TextChoices):
    REGION_1 = "Иссык-куль", "Иссык-куль"
    REGION_2 = "Чуй", "Чуй"
    REGION_3 = "Ош", "Ош"
    REGION_4 = "Талас", "Талас"
    REGION_5 = "Нарын", "Нарын"

# Категории продуктов (Говядина, Баранина, Кисломолочные и т.д.)
class Categories(models.Model):
    Name_of_category = models.CharField(verbose_name='Наименование категории', max_length=75)
